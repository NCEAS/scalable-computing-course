...
::: {.callout-important}
## TODO
- elaborate on localhost in note below
- (https://github.com/NCEAS/scalable-computing-examples/blob/main/group-project/solutions/session-06-solution.ipynb) - example if you're using a highthroughput executor through a gateway, need IP
- we'll need IP addresses to connect to remote clusters; IP address lets you connect to a vm
:::
...
::: {.callout-note} 
## A couple important IP addresses
...
2. **localhost** is a hostname that refers to your local device with an IP address 127.0.0.1
:::

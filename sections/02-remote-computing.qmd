...
Alternatively, click on the green bar that says **SSH: included-crab.nceas.ucsb.edu** (bottom left corner of VS Code), which opens the command palette. Choose **Close Remote Connection** to disconnect from the server.
:::

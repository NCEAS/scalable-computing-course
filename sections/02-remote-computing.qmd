...
2. Use the `ls` command to list the contents (any files or subdirectories) of your home directory -- you should see a directory named **?_**

3. Use the `cd` command to move the **?** directory:

```{bash}
# move from /home/yourusername to home/yourusername/?
cd ?
```
...
```{bash}
# move from /home/yourusername/? back to /home/yourusername
$ cd ..
```

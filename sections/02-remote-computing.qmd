...
Let's practice using some of above commands. 
...
3. Verify that you've successfully navigated back to your home directory using `pwd`
...
## Exercise: Write a bash shell script

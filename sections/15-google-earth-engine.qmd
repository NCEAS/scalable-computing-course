...
We'll start with a shorter
## Exercise 1: Getting started with Google Earth Engine (GEE) 

::: {.callout-note}
## GEE libraries were installed when you set up your `scomp` virtual environment

We'll be using a few different libraries that should already be installed if you successfully set up your `scomp` virtual environment.
:::

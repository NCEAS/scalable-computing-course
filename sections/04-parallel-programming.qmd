...
```{python}
    # list of data files
    # curl https://arcticdata.io/metacat/d1/mn/v2/query/solr/?q=id:*A2NK3665N+AND+formatType:METADATA\&fl=documents\&wt=json | jq .response.docs[].documents[]
    ...
    id_list = (
      ...
      "urn:uuid:ea99e31b-572a-4175-92d2-0a4a9cdd8366",
      "urn:uuid:c45e3d93-e908-4f44-85c6-82c4c002a259",
      "urn:uuid:a0aa394e-b0df-4daf-9011-09bba3c3d0b5",
      "urn:uuid:5634766f-af81-46f8-acc5-e15f9cd2e3fb",
      "urn:uuid:94a3fae2-f2f2-4e28-b51b-4a66b7b42331",
      "urn:uuid:c7aac289-e2be-4be7-85df-6d2fdb5293d5",
      "urn:uuid:07b9ca95-1463-414a-a3e0-7f466772d891",
      "urn:uuid:695b949c-339d-4f51-a593-4d332aa86748",
      "urn:uuid:e54142ed-dbb3-4b27-9756-d2262c6c069a",
      "urn:uuid:57dcf9f5-2f25-4d37-a793-821edb2dda19",
      "urn:uuid:75f20002-f4bf-4721-b480-d115d4042e79",
      "doi:10.18739/A2NK3665N",
      "urn:uuid:fe73a6b1-86af-495f-9292-ad22e86a4aa0",
      "urn:uuid:938856af-d78d-4580-ab63-bb2ce8484c77",
      "urn:uuid:705a3af3-fe5b-42d3-851f-e6093c15ee5c",
      "urn:uuid:6c1ea229-8bfa-4e0f-bf6b-cff8e03865fb",
      "urn:uuid:801e617c-4464-431d-b5c2-a8c16b543e7b",
      "urn:uuid:bdf983fc-9864-4e08-9d3a-768afe36bf5f",
      "urn:uuid:e1d9eb59-6e2b-4c0f-b048-206badd03fd1",
      "urn:uuid:5bf32df3-83bf-4985-b682-560936247516",
      "urn:uuid:7c1a1730-f1dc-43a7-96c2-fe99d480c87e"
    )
```
...
def download_file(pid):
    """
    Downloads the data based on its identifier
    """
    service = "https://arcticdata.io/metacat/d1/mn/v2/object/"
    url = service + pid
    print("Downloading: " + pid)
    msg = urllib.request.urlretrieve(url, pid)
    return msg

@timethis
def download_list(dl_list):
    return [download_file(pid) for pid in dl_list]

results = download_list(id_list[0:3])
```

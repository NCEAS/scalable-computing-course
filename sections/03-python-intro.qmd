...
Once connected, use the `pwd` command to make sure you're in your home directory (`/home/yourusername`). Use the `ls` command to list out the contents of your home directory and ensure that you have a clone of the `scalable-computing-examples` respository (this should have been completed during [Exercise 3](http://localhost:6226/sections/02-remote-computing.html#exercise-3-clone-a-github-repository-to-the-server) in the [Remote Computing](http://localhost:6226/sections/02-remote-computing.html) session).

...
-   [SFTP & RSync]{style="background-color: #F8E5D8;"}: For users that expect to upload hundreds or thousands of files, with a cumulative file size of hundreds of GB to TBs, you will likely want to make use of SFTP through Globus, or use RSync. Jeanette will be talking about data transfers in more depth on Thursday.
...
*This will be a summary of the chapter*

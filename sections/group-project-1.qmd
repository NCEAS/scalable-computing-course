...
Ice wedges form as a result of cycles of thermal contraction during long-term melting and freezing cycles of permafrost. This environmental feature is a sign of permafrost thaw over time, which is a result of the warming climate. Identifying where these features exist is important to understanding how the Arctic landscape is changing, and will help researchers, community members, and policy-makers protect address threats to the biota and architecture throughout the region. To learn more about how this data was produced, see [this](https://doi.org/10.5194/isprs-archives-XLIV-M-3-2021-175-2021) publication.

Ice wedges can form very distinctive enclosed geometries that are clearly visible in high-resolution satellite images. The PDG team is using advanced analysis and computational tools to process high-resolution satellite imagery and automatically dectect where ice wedge polygons form. Below is an example of a satellite image (left) and the detected ice wedge polygons in geospatial vector format (right) of that same image.
